 ...
 ****************************************************************************/
 ...
 /*
 * Names:
 *   1.  uWaterloo User ID:  mkllam@uwaterloo.ca
 *   2.  uWaterloo User ID:  ptorres@uwaterloo.ca
 */
...
*               to main.c or bst.c.
*****************************************************************
*  1.  Added indents to bst_init for readability
*  2.  Added indents inside bst_insert for readability
*  3.  Added indent to bst_min()'s while loop for readability
*  4.  Added indents within bst_delete for readability
*  5.  Added some new lines to an if statement inside bst_delete for readability
****************************************************************/
...
*****************************************************************
*  1.  Decrement in bst_erase corrected from += to -=.  Visually detected.
*  2.  Bst_delete case 3 & changed to &&.  Debugger failed and cornered the error to erase or delete.
*  3.  Bst_delete case 3 when searching for largest node: changed ->left to ->right
*  4.  Bst_delete case 2 check if child is to the right: changed ->left to ->right 
****************************************************************/
